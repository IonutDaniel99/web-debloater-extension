...
import { WHATSAPP_CONFIG } from '@/page-scripts/whatsapp/whatsapp_config';

const SITE_ID = 'whatsapp';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            <div className={cn(
              ...
              "bg-gradient-to-br from-[#25D366]/10 to-[#25D366]/5",
              "ring-1 ring-[#25D366]/20"
            )}>
